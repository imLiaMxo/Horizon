...
<div class="overflow-auto h-screen pb-24 px-4 md:px-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-4 w-full text-black dark:text-white">
        @forelse($applications as $application)
        <a href="{{ route('admin.apply.view', $application->id) }}" class="w-full flex p-3 pl-4 items-center bg-gray-200 dark:bg-indigo-500 hover:bg-gray-300 dark:hover:bg-indigo-700 rounded-lg cursor-pointer">
